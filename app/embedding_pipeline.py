...
class ChromaEmbeddingPipelineTextOnly:
    ...
    def extract_document_category_from_filename(self, filename: str) -> str:
        ...
        if 'cv' in filename_lower:
            return 'cv'
        elif 'projects' in filename_lower:
            return 'projects'
        elif 'interview_qa' in filename_lower:
            return 'interview_qa'
        elif 'notes' in filename_lower:
            return 'notes'
        elif 'behavioral' in filename_lower:
            return 'behavioral'
...
def main():
    ...
    parser.add_argument('--collection-name', default='interview_coach', help='Interview Coach Collection Name')
