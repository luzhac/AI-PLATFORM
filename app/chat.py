#!/usr/bin/env python3
"""
Interview RAG Chat with RAGAS Evaluation Integration
...
# Page configuration
st.set_page_config(
    page_title="Interview coach with Evaluation",
    page_icon="🚀",
    layout="wide"
)
...
def main():
    st.title("🚀Interview coach Chat with Evaluation")
    st.markdown("Chat with AI about interview coach with real-time quality evaluation")
    ...
    # Chat input
    if prompt := st.chat_input("Ask about interview..."):
